...
const Footer = () => {
    return (
        <>
            <footer>
                <div className='div1' style={{ backgroundColor: "black" }}>

                    <ul className='flex flex-col gap-4 pt-20 pl-5 '>
                ...
                <div className='div2' style={{ backgroundColor: "black" }}>
                    <ul className='flex flex-col gap-4 pt-20 pl-5'>
                ...
                <div className='div3' style={{ backgroundColor: "black" }}>
                    <ul className='flex flex-col gap-4 pt-20 pl-5'>
                        <li className=" subFooter  logo text-lg font-bold">Account</li>
                        <li className='logo'><a href="#">My accound</a></li>
                        <li className='logo'><a href="#">Login/Register</a></li>
                        <li className='logo'><a href="#"> Cart</a></li>
                        <li className='logo'><a href="#"> Wishlist</a></li>
                        <li className='logo'><a href="#">Shop</a></li>
                    </ul>
                </div>
                <div className='div4' style={{ backgroundColor: "black" }}>
                    <ul className='flex flex-col gap-4 pt-20 pl-5'>
                        <li className=" subFooter  logo text-lg font-bold"><a href="#">Quick Link</a></li>
                        <li className='logo'><a href="#">Privacy poly</a></li>
                        <li className='logo'><a href="#">Terms & Use</a></li>
                        <li className='logo'><a href="#">FAQ</a></li>
                        <li className='logo'><a href="#">Contact us</a></li>
                    </ul>
                </div>
                <div className=" bg-black text-white p-5">
                    <ul className=" pt-14">
                        <li className="text-lg font-bold mb-1">Download App</li>
                        <li className="pt-5 text-sm text-gray-400 mb-4">Save 3$ with new user!</li>
